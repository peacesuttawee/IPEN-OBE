...
export const Topbar: React.FC<TopbarProps> = ({ title, subtitle, onRefresh, onDebug }) => {
  return (
    <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 p-6 sticky top-0 z-20 flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h2 className="m-0 text-2xl font-extrabold text-slate-800 tracking-tight">{title}</h2>
